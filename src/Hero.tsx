...
import RolesSection from './roles'
 ...
 export default function Hero() {
  ...
  return(
    <>
      <div className="hero flex flex-col w-[100%] h-[100vh] items-center justify-center mt-15 fade-in mx-auto">

       <div className="flex flex-col w-[75%] h-[80%] items-center gap-5">
          <div className="flex slide-down">
            <h1 className="text-white font-bold text-3xl text-shadow-md  fade-in mt-5">AGI</h1>
          </div>
            {/* TITLE DIV */}
